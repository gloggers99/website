    ...
    return (
        <div className={"min-h-screen snap-start flex flex-col"}>
            ...
            <div className={"justify-center items-center gap-5 flex flex-col flex-1"}>
                <h1 className={"text-3xl"}>This section is a work in progress.</h1>
                <div className={"flex flex-row items-center gap-5"}>
                    <p className={"text-xl"}>For now please refer to my GitHub account:</p>
                    <SocialLink icon={<SiGithub size={40} />}
                                link={"https://github.com/gloggers99"} />
                </div>
                <div className={"flex flex-row items-center gap-5"}>
                    <p className={"text-xl"}>For inquiries please contact me via email:</p>
